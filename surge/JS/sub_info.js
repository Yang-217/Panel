...
[Script]
Sub_info = type=generic,timeout=10,script-path=https://raw.githubusercontent.com/Yang-217/Panel/main/surge/JS/sub_info.js,script-update-interval=0,argument=url=[URL encode 后的机场节点链接]&reset_day=1&title=AmyInfo&icon=bonjour&color=#007aff
...
(async () => {
  ...
  let content = [`用量：${bytesToSize((used)*100 + % )} | ${bytesToSize(total)}`];
